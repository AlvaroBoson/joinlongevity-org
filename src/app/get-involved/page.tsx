                ...
                <div className="flex flex-col lg:flex-row items-start gap-20">
                  ...
                  <StaggerChildren className="flex-1" key={pathname + "-event-images"}>
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
                      {[
                        { name: "ARDD", imageSrc: "/image/getinvolved/ardd.webp", targetUrl: "/conferences/ardd" },
                        { name: "LSD", imageSrc: "/image/getinvolved/lsd.webp", targetUrl: "/conferences/longevity-summit-dublin" },
                        { name: "TransVision", imageSrc: "/image/getinvolved/transvision.webp", targetUrl: "/conferences/transvision" },
                        { name: "LBF", imageSrc: "/image/getinvolved/lbf.webp", targetUrl: "/hubs/longevity-biotech-fellowship" },
                        { name: "Vitalism", imageSrc: "/image/getinvolved/vitalism.webp", targetUrl: "/communities/vitalism" },
                        { name: "Social media", imageSrc: "/image/getinvolved/socialmedia.webp", targetUrl: "#stay-up-to-date" }
                      ].map((item, index) => (
                         <Link href={item.targetUrl} key={item.name + "-link"} className="group block" onClick={item.targetUrl.startsWith("#") ? scrollToSection : undefined}>
                           <motion.div
                             variants={fadeInUp}
