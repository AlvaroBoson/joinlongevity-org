      ...
      <FadeInUp as="section" className="w-full py-28 bg-white flex flex-col items-center justify-center">
        <div className="max-w-3xl w-full flex flex-col items-center px-4">
          <p className="text-xl leading-relaxed text-center mb-8 text-gray-600">
            <span className="font-extrabold text-[#64BC6E]">Longevity</span> is advancing slowly. Part of the problem is that the word &quot;<span className="font-extrabold text-[#64BC6E]">longevity</span>&quot; is being misused to sell everything from supplements to skincare. That creates <span className="font-extrabold text-gray-900">confusion</span> and drowns out the <span className="font-extrabold text-[#64BC6E]">real mission</span>. At the same time, too many people still assume it&apos;s only for the <span className="font-extrabold text-gray-900">rich</span> or <span className="font-extrabold text-gray-900">highly educated</span>. But <span className="font-extrabold text-[#64BC6E]">progress</span> happens when <span className="font-extrabold text-[#64BC6E]">new people</span> join in. The field needs voices from <span className="font-extrabold text-[#64BC6E]">all backgrounds</span>, especially <span className="font-extrabold text-[#64BC6E]">creators, advocates</span>, and anyone willing to <span className="font-extrabold text-[#64BC6E]">care</span>.
          </p>
          <p className="text-xl leading-relaxed text-center text-gray-600">
            <span className="font-extrabold text-gray-900">You don&apos;t need a degree</span>. You just need to <span className="font-extrabold text-[#64BC6E]">show up</span> and <span className="font-extrabold text-[#64BC6E]">do what&apos;s right</span>.
          </p>
        </div>
      </FadeInUp>
      ...
      <FadeInUp as="section" className="w-full py-28 bg-[#1E2A38] flex flex-col items-center justify-center">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <StaggerChildren className="flex flex-col md:flex-row items-center justify-center gap-4 md:gap-16 max-w-5xl mx-auto">
            ...
            {/* Mobile OR divider - MOVED HERE and always rendered but hidden on md+ */}
            <motion.div variants={fadeInUp} className="md:hidden text-2xl font-bold text-white text-center my-4">
              OR
            </motion.div>

            {/* Desktop OR divider - Remains hidden on mobile */}
            <motion.div variants={fadeInUp} className="hidden md:block text-2xl font-bold text-white">
              OR
            </motion.div>
            ...
            <motion.div variants={fadeInUp}>
              <FeatureCard
                title="Get involved"
                description="Longevity needs more than scientists. Find ways to contribute your skills, join projects, or advocate for the field, no matter your background."
