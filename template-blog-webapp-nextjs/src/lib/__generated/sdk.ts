...
export type PageBlogPost = Entry & _Node & {
  ...
  _id: Scalars['ID']['output'];
  authorsCollection?: Maybe<PageBlogPostAuthorsCollection>;
...
/** To create individual blog posts [See type definition](https://app.contentful.com/spaces/sxjvf25fxhhp/content_types/pageBlogPost) */
export type PageBlogPostAuthorsCollectionArgs = {
  limit?: InputMaybe<Scalars['Int']['input']>;
  locale?: InputMaybe<Scalars['String']['input']>;
  order?: InputMaybe<Array<InputMaybe<PageBlogPostAuthorsCollectionOrder>>>;
  preview?: InputMaybe<Scalars['Boolean']['input']>;
  skip?: InputMaybe<Scalars['Int']['input']>;
...
export type PageBlogPostAuthorsCollection = {
  __typename?: 'PageBlogPostAuthorsCollection';
  items: Array<Maybe<ComponentAuthor>>;
  limit: Scalars['Int']['output'];
  skip: Scalars['Int']['output'];
  total: Scalars['Int']['output'];
...
export enum PageBlogPostAuthorsCollectionOrder {
  InternalNameAsc = 'internalName_ASC',
  InternalNameDesc = 'internalName_DESC',
  NameAsc = 'name_ASC',
  NameDesc = 'name_DESC',
...
export type PageBlogPostFilter = {
  ...
  authors?: InputMaybe<CfComponentAuthorNestedFilter>;
